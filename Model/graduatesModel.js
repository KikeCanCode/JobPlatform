...
class Graduate {
    constructor(username, email, password, firstName, lastName, contactNumber, qualification, bootcampInstitute, graduationYear, skills, certificatePath) {
...
static async signup(username, email, password) {
  ...
  static async uploadCertificate(graduateId, certificatePath) {
    try {
      const result = await db.update('graduates')
