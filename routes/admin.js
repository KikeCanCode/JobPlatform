...
//Get Company by Id
router.get("/companies/:id", verifyToken, isAdmin, async (req, res) =>{
    const { id } = req.params;
...
// Get Graduate by id 
router.get("/graduates/:id", verifyToken, isAdmin, async (req, res) =>{
    const { id } = req.params;
...
router.get("/graduates", verifyToken, async (req, res) => {
    try {
